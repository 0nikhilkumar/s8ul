        ...
        <section className="policy">
            ...
            <div className="policy__container">
                ...
                <div className="policy__header">
                    ...
                    <p className="policy__updated">Last updated on 11-04-2025 16:44:31</p>
                </div>
                ...
                <div className="policy__content">
                    <div className="policy__section">
                        <p className="policy__text">
                            These Terms and Conditions, along with privacy policy or other terms ("Terms") constitute a binding agreement by and between <span className="policy__highlight">S8UL CREATIVES</span>, ("Website Owner" or "we" or "us" or "our") and you ("you" or "your") and relate to your use of our website, goods (as applicable) or services (as applicable) (collectively, "Services").
                        </p>
                        <p className="policy__text">
                    ...
                    <div className="policy__section">
                        <h2 className="policy__section-title">Terms of Use</h2>
                    ...
                    <div className="policy__section">
                        <h2 className="policy__section-title">Governing Law & Jurisdiction</h2>
                        <p className="policy__text">
                        ...
                        <p className="policy__text">
                            All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in <span className="policy__highlight">Mumbai, MAHARASHTRA</span>.
                        </p>
                        <p className="policy__text">
